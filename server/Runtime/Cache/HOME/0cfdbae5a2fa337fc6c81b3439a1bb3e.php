...
<html>
    <head>
        ...
        <link rel="stylesheet" href="<?php echo U('FrontendRuntime/index?action=getCss');?>" />
    ...
    <body ng-controller="MainCtl" ng-keydown="doMainKeyDown($event)">
        <header class="topest clearfix">
            ...
            <div class="pull-right topbar-right">
                <?php echo tag("nav_bar_dropdown_html");?>
            ...
            <aside ng-class="{'nexpand':!sidebar_expand}">
                ...
                <div class="sidebar-user clearfix">
                    <a ng-click="$root.goPage('/my/preference')" class="sidebar-user-photo pull-left">
                        <img class="img-circle" ng-src="./uploads/Avatars/zhaopian.jpg" width="40" />
                    </a>
            ...
            <article class="main-content-container" ng-class="{'when_sidebar_nexpand':!sidebar_expand}">
                <div class="main-content-heading">
                    ...
                    <div class="main-content-heading-tools">
                        ...
                        class="chat" 
                        onclick="if(navigator.userAgent.toLowerCase().indexOf('opera') != -1 && window.event.preventDefault) window.event.preventDefault();this.newWindow = window.open('https://chat.ng-erp.com/index.php/chn', 'Online Support', 'toolbar=0,scrollbars=0,location=0,status=1,menubar=0,width=640,height=450,resizable=0');this.newWindow.focus();this.newWindow.opener=window;return false;">
                ...
                <div class="page-content">
                    ...
                    <div class="row footer-copy">
                        <p class="text-center">
                            &copy; 2015 Present by <a href="#" target="_blank">KingMo</a>
                        </p>
                    </div>
                    <!--//demo-->
                </div><!-- /.page-content -->
        ...
        <script type="text/javascript">
            var ones = {
                ...
                basePath: '<?php echo ($APP_PATH); ?>',
                userInfo: <?php echo ($userInfo); ?>,
                asyncScript: [],
            };
            <?php if(DBC('site.html5.mode')): ?>ones.useHTML5 = <?php echo DBC('site.html5.mode');?>;<?php endif; ?>
        </script>
        <?php if(is_array($javascripts)): foreach($javascripts as $key=>$js): ?><script src="<?php echo ($js); ?>"></script><?php endforeach; endif; ?>
